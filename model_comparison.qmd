...
We will learn to compare models using anova, AIC, and step wise regression.
...
model 3, but without our previous knowledge on model 2, we would not know if it was hp or disp that was the improvement. m3 being better than m1, does not mean that m3 is better than m2.
