...
The differences between the bad, good, and medium price averages/majority of prices for those products are generally around \$125. This maybe means that the shelveloc variable doesn't effect the price much.

The base price, \$114 is the price regardless of the shelve location. The good shelve is slightly more than medium, (compared to bad), but not statistically significant.
...
#old model variables 
##ShelveLoc * Price * Urban * US * CompPrice * Income * Advertising * Population * Price * Age * Education,
summary(lm.carseats)
...
Most of the variables are not good indicators of sales. Compprice, Income, advertising, shelve good and age are all statistically significant.
...
This model can inform business decisions regarding pricing, advertising and product placement, by helping businesses decide what to spend their resources on. Based on this model, Businesses may want to place car seats they want sold in the "good" shelves. Businesses may not need to consider population in their sales, which may signify that regardless of population, car seats sales still need to be made.

Businesses may want to continue using comparative pricing as it increased car sales.\
The biggest impact on sales is shelf location, but putting money in advertising is also important. However, Shelf location and advertising are not dependent on each other as a predictor of sales.
